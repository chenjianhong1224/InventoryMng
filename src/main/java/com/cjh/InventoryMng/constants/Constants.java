package com.cjh.InventoryMng.constants;

public class Constants {

	public static String BrandsysParamName = "brand";

	public static String ManufacturersysParamName = "manufacturer";

	public static String SysEmailParamName = "sysEmail";
